...
import net.oaster2000.newmod.slot.SlotCrucibleOutput;
...
public class ContainerCrucible extends Container
{
    ...
    public ContainerCrucible(InventoryPlayer playerInventory, TileEntityCrucible furnaceInv)
    {
        this.tileFurnace = furnaceInv;
        this.addSlotToContainer(new Slot(furnaceInv, 0, 56, 17));
        this.addSlotToContainer(new SlotCrucibleFuel(furnaceInv, 1, 56, 53));
        this.addSlotToContainer(new SlotCrucibleOutput(playerInventory.player, furnaceInv, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (CrucibleRecipies.instance().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityCrucible.isItemFuel(itemstack1))
                {
