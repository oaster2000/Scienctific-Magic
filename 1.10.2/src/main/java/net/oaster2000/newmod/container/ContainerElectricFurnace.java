...
import net.oaster2000.newmod.slot.SlotElectricFurnaceOutput;
...
public class ContainerElectricFurnace extends Container
{
    ...
    public ContainerElectricFurnace(InventoryPlayer playerInventory, TileEntityElectricFurnace furnaceInv)
    {
        this.tileFurnace = furnaceInv;
        this.addSlotToContainer(new Slot(furnaceInv, 0, 56, 35));
        this.addSlotToContainer(new SlotElectricFurnaceFuel(furnaceInv, 1, 8, 52));
        this.addSlotToContainer(new SlotElectricFurnaceOutput(playerInventory.player, furnaceInv, 2, 116, 35));
