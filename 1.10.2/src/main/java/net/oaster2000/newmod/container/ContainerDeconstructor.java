...
import net.oaster2000.newmod.slot.SlotDeconstructorOutput;
...
public class ContainerDeconstructor extends Container
{
    ...
    public ContainerDeconstructor(InventoryPlayer playerInventory, TileEntityDeconstructor furnaceInv)
    {
        this.tileFurnace = furnaceInv;
        this.addSlotToContainer(new Slot(furnaceInv, 0, 56, 35));
        this.addSlotToContainer(new SlotDeconstructorFuel(furnaceInv, 1, 8, 52));
        this.addSlotToContainer(new SlotDeconstructorOutput(playerInventory.player, furnaceInv, 2, 116, 35));
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.listeners.size(); ++i)
        {
            ...
            {
                icontainerlistener.sendProgressBarUpdate(this, 4, this.tileFurnace.getField(4));
            }
            

            if (this.capacity != this.tileFurnace.getField(5))
            {
                icontainerlistener.sendProgressBarUpdate(this, 5, this.tileFurnace.getField(5));
            }
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 1 && index != 0)
            {
                ...
                if (TileEntityDeconstructor.isItemFuel(itemstack1))
                {
