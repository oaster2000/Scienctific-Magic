...
public class SlotMaceratorOutput extends Slot
{
    ...
    public SlotMaceratorOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = MaceratorRecipies.instance().getSmeltingExperience(stack);
