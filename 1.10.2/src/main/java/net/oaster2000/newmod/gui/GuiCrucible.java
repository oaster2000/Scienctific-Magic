...
public class GuiCrucible extends GuiContainer
{
    ...
    private final TileEntityCrucible tileFurnace;

    public GuiCrucible(InventoryPlayer playerInv, TileEntityCrucible furnaceInv)
    {
        super(new ContainerCrucible(playerInv, furnaceInv));
