...
public class GeneratorBlock extends BlockContainer{
	...
	public GeneratorBlock(boolean isActive, String unlocalizeName) {
		super(Material.IRON);
	  ...
	  @Nullable
	    ...
	    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            FMLNetworkHandler.openGui(playerIn, Main.instance, 3, worldIn, pos.getX(), pos.getY(), pos.getZ());
	    ...
	    public static void setState(boolean active, World worldIn, BlockPos pos)
	    {
	        ...
	        if (active)
	        {
	            worldIn.setBlockState(pos, ModBlocks.gen_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModBlocks.gen_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	        else
	        {
	            worldIn.setBlockState(pos, ModBlocks.gen.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModBlocks.gen.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
