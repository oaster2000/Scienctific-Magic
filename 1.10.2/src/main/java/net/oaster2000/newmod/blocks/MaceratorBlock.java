...
public class MaceratorBlock extends BlockContainer{
	...
	public MaceratorBlock(boolean isActive, String unlocalizeName) {
	  ...
	  @Nullable
	    ...
	    {
	        return Item.getItemFromBlock(ModBlocks.macerator);
	    }
	    ...
	    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            FMLNetworkHandler.openGui(playerIn, Main.instance, 1, worldIn, pos.getX(), pos.getY(), pos.getZ());
	    ...
	    public static void setState(boolean active, World worldIn, BlockPos pos)
	    {
	        ...
	        if (active)
	        {
	            worldIn.setBlockState(pos, ModBlocks.macerator_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModBlocks.macerator_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	        else
	        {
	            worldIn.setBlockState(pos, ModBlocks.macerator.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModBlocks.macerator.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	    ...
	    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
	    {
	        ...
	        if (stack.hasDisplayName())
	        {
	            ...
	            if (tileentity instanceof MaceratorTileEntity)
	            {
	                ((MaceratorTileEntity)tileentity).setCustomInventoryName(stack.getDisplayName());
	            }
	        }
	    }
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	        if (!keepInventory)
	        {
	            ...
	            if (tileentity instanceof MaceratorTileEntity)
	            {
	                InventoryHelper.dropInventoryItems(worldIn, pos, (MaceratorTileEntity)tileentity);
	    ...
	    {
	        return new ItemStack(ModBlocks.macerator);
	    }
