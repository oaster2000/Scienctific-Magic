...
public class SolarGeneratorBlock extends BlockContainer{
	  ...
	  @Nullable
	    ...
	    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            FMLNetworkHandler.openGui(playerIn, Main.instance, 4, worldIn, pos.getX(), pos.getY(), pos.getZ());
	    ...
	    public static void setState(boolean active, World worldIn, BlockPos pos)
	    {
	        ...
	        if (active)
	        {
	            worldIn.setBlockState(pos, ModBlocks.sunGen_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModBlocks.sunGen_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	        else
	        {
	            worldIn.setBlockState(pos, ModBlocks.sunGen.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModBlocks.sunGen.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	        if (!keepInventory)
	        {
	            ...
	            if (tileentity instanceof TileEntitySolarGenerator)
	            {
	                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntitySolarGenerator)tileentity);
	    ...
	    {
	        return new ItemStack(ModBlocks.sunGen);
	    }
